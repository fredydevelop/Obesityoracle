...
def multi(input_data):
    ...
    if predict:
        ...
        dfresult = pd.DataFrame({
            ...
            "Recommendation 1": [r[1] for r in recommendations_split],
            "Recommendation 2": [r[2] for r in recommendations_split],
            "Recommendation 3": [r[3] for r in recommendations_split],
        })
